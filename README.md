...
Client side routing allows us to change the content of our web pages based on
the URL without causing a new network request to fire. It offers some
performance benefits but the biggest benefit is that it allows us to make very
interactive websites easily.
